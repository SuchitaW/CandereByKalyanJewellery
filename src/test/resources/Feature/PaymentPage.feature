...
Feature: E-Commerce website healthcheck
  ...
  @OrderPlaceUPI
  Scenario Outline: To verify UPI order place functionality
  ...
  @OrderPlaceCODPartial
  Scenario Outline: To verify COD-partial order place functionality
    When User see Your Account and click on  Log In  from home page
    And User enters "<Emailidmobileno>"
    And User click on continue button
    And User enter otp manually and click on login
  ...
  @OrderPlaceDGRP
  Scenario Outline: To verify DGRP order place functionality
  ...
  @ViewWallet
  Scenario Outline: To verify View Wallet functionality
    When User see Your Account and click on  Log In  from home page
    And User enters "<Emailidmobileno>"
    And User click on continue button
    And User enter otp manually and click on login
    ...
    And User click on Checkout Securely
    And User click on continue button on shipping page
    And User Click on view wallet
    And Enter the amount
    And User click on apply
    And User are able to see the Wallet amount applied successfully and show in order summery
